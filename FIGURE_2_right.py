...
ax.set_ylabel(r"$E_{\text{gen}}^{} - E_{\text{gen}}^{\text{BO}}$", labelpad=2.0)
...
# unbounded
data_fp = np.genfromtxt(
    "./data/FIGURE_2_epslogeps_huber.csv",
    delimiter=",",
    skip_header=1,
)

epslogeps_fit = data_fp[:, 0]
huber_err_fit = data_fp[:, 1]
