...
ax.plot(delta_larges, l2_err, label=r"$\ell_2$", color="tab:blue")
ax.plot(delta_larges, l1_err, label=r"$\ell_1$", color="tab:green")
ax.plot(delta_larges, huber_err, label="Huber", color="tab:orange")
ax.plot(delta_larges, bo_err, label="BO", color="tab:red")

# ax.plot(delta_larges, l2_err_ub, label=r"$\ell_2$ ub.")
# ax.plot(delta_larges, l1_err_ub, label=r"$\ell_1$ ub.")
# ax.plot(delta_larges, huber_err_ub, label="Huber ub.")
# ax.plot(delta_larges, bo_err_ub, label="BO ub.")
...
# ax_2.plot(delta_larges, l2_lambda_ub, label=r"$\lambda_{\text{opt}}\:\ell_2$ clipp")
# ax_2.plot(delta_larges, l1_lambda_ub, label=r"$\lambda_{\text{opt}}\:\ell_1$ clipp")
# ax_2.plot(delta_larges, hub_lambda_ub, label=r"$\lambda_{\text{opt}}\:$ Huber clipp")
# ax_2.plot(delta_larges, a_hub_ub, label=r"$a_{\text{opt}}\:$Huber clipp")
