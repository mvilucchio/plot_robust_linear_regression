...
ax.plot(delta_larges_ub, l2_err_ub, label=r"$\ell_2$ ub.", color="tab:blue")
ax.plot(delta_larges_ub, l1_err_ub, label=r"$\ell_1$ ub.", color="tab:green")
ax.plot(delta_larges_ub, huber_err_ub, label="Huber ub.", color="tab:orange")
ax.plot(delta_larges_ub, bo_err_ub, label="BO ub.", color="tab:red")
...
ax_2.plot(delta_larges_ub, l2_lambda_ub, label=r"$\lambda_{\text{opt}}\:\ell_2$ clipp", color="tab:blue")
ax_2.plot(delta_larges_ub, l1_lambda_ub, label=r"$\lambda_{\text{opt}}\:\ell_1$ clipp", color="tab:green")
ax_2.plot(delta_larges_ub, hub_lambda_ub, label=r"$\lambda_{\text{opt}}\:$ Huber clipp", color="tab:orange")
ax_2.plot(delta_larges_ub, a_hub_ub, label=r"$a_{\text{opt}}\:$Huber clipp", color="tab:gray")
